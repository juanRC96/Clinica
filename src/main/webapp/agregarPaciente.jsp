...
<p>Ingrese DNI <input type=text name="dni" size=50></p>
<p>Ingrese nombre <input type=text name="nombre" size=50></p>
<p>Ingrese apellido <input type=text name="apellido" size=50></p>

<p>
	<label for="datepicker">Ingrese fecha de nacimiento</label>
	<input type="text" name="fecha_nac" id="datepicker">
</p>
...
%>
<p>Seleccione la obra social  <select name="obrasocial">
...
<p>Ingrese direccion <input type=text name="direccion" size=50></p>
<p>Ingrese telefono <input type=text name="telefono" size=50></p>
...
<form method="post" action="menuPacientes.html"><p><button id="menu" type="bt3">Volver</button></form>
