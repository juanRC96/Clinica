...
<form method="post" action="./svbuscarpacientesolopublico" action="reservarTurnos.jsp">
...
<form method="post" action="menuReservarTurnoPublico.html"><p><button id="bt3" type="submit">Volver</button></form>
